...
resource "cloudflare_zero_trust_access_application" "bazarr" {
  account_id           = var.cloudflare_account_id
  name                 = "TF - Bazarr"
  type                 = "self_hosted"
  session_duration     = "24h"
...
resource "cloudflare_zero_trust_access_application" "dispatcharr" {
  account_id           = var.cloudflare_account_id
  name                 = "TF - Dispatcharr"
  type                 = "self_hosted"
  session_duration     = "24h"
  ...
  app_launcher_visible = true
  logo_url = "https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/png/dispatcharr.png"
...
resource "cloudflare_zero_trust_access_application" "lidarr" {
  ...
  app_launcher_visible = true
  logo_url = "https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/png/lidarr.png"
...
resource "cloudflare_zero_trust_access_application" "slskd" {
  account_id           = var.cloudflare_account_id
  name                 = "TF - Slskd"
  type                 = "self_hosted"
  session_duration     = "24h"
  ...
  app_launcher_visible = true
  logo_url = "https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/png/slskd.png"
...
resource "cloudflare_zero_trust_access_application" "aurral" {
  account_id           = var.cloudflare_account_id
  name                 = "TF - Aurral"
  type                 = "self_hosted"
  session_duration     = "24h"
...
resource "cloudflare_zero_trust_access_application" "portainer_oidc" {
  account_id           = var.cloudflare_account_id
  name                 = "TF - Portainer"
  type                 = "saas"
  session_duration     = "24h"
  ...
  app_launcher_visible = true
  logo_url = "https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/png/portainer.png"

  saas_app = {
    auth_type = "oidc"
    app_launcher_url = "https://portainer.${var.tld}"
    access_token_lifetime = "24h"
    redirect_uris = [
      "https://portainer.${var.tld}/"
    ]
    grant_types = [
      "authorization_code",
    ]
...
resource "cloudflare_zero_trust_access_application" "ha_oidc" {
  account_id           = var.cloudflare_account_id
  ...
  app_launcher_visible = true
  logo_url = "https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/png/home-assistant.png"
...
resource "cloudflare_zero_trust_access_application" "opencode" {
  ...
  destinations = [
    { 
      type = "public"
      uri = "opencode.${var.tld}"
    }
  ]
}

resource "cloudflare_zero_trust_access_application" "opencode_ssh" {
  account_id           = var.cloudflare_account_id
  name                 = "TF - SSH Opencode"
  type                 = "ssh"
  session_duration     = "8h"
  ...
  destinations = [
    { 
      type = "public"
      uri = "opencodessh.${var.tld}"
    }
  ]
}

resource "cloudflare_zero_trust_access_application" "forgejo" {
  account_id           = var.cloudflare_account_id
  name                 = "TF - Forgejo"
  type                 = "saas"
  session_duration     = "24h"
  ...
  app_launcher_visible = true
  logo_url = "https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/png/forgejo.png"

  saas_app = {
    auth_type = "oidc"
    app_launcher_url = "https://git.${var.tld}"
    access_token_lifetime = "24h"
    redirect_uris = [
      "https://git.${var.tld}/user/oauth2/cloudflare/callback"
    ]
    grant_types = [
      "authorization_code",
    ]
